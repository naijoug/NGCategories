#
#  Be sure to run `pod spec lint NGCategories.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "naijoug"
  # s.authors            = { "naijoug" => "naijoug@126.com" }
  # s.social_media_url   = "https://twitter.com/naijoug"
  ...
  s.source_files  = "NGCategories", "NGCategories/**/*.{h,m}"
